...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '10feb90d3286491ea889c6b3bc21870d',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '坚信 Not Only Coding 的 Coder', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.qizong007.top', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    '王帅真, qizong007, 独立开发, 博客, Notion', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '闽ICP备2020020906号-2', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK:
