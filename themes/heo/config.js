const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-01-20', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.qizong007.top' }
  ],
  ...
  HEO_HERO_TITLE_3: 'BLOG.QIZONG007.TOP',
  HEO_HERO_TITLE_4: 'Always Day1',
  HEO_HERO_TITLE_5: '不止编码｜Not Only Coding',
  HEO_HERO_TITLE_LINK: 'https://blog.qizong007.top',
  // 英雄区遮罩文字
  ...
  HEO_HERO_CATEGORY_3: { title: '技术干货', url: '/tag/技术干货' },
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/qizong007',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_ICON_ORCID: 'fab fa-orcid',
  HEO_INFO_CARD_URL3:
    'https://m.okjike.com/users/bb668784-6bbc-456d-989c-1f8e90f6fd95',
